...
export default function Contact() {
  ...
  return (
    ...
    <section
  id="contact"
  className={`py-16 px-4 sm:px-6 transition-colors duration-300 ${
...
>
  <div className="max-w-3xl mx-auto">
        ...
        {[
          ...
          <li key={idx}>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`flex items-center gap-3 text-base sm:text-lg no-underline ${
                darkMode
    ...
    >
      {/* Name */}
      <div className="flex flex-col">
        <label htmlFor="name" className="mb-2 font-medium text-sm sm:text-base">
          Name
        </label>
        <input
          type="text"
          ...
          onChange={handleChange}
          placeholder="Your name"
          className={`px-4 py-3 rounded-md border text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 transition ${
            darkMode
              ? "bg-gray-800 border-gray-600 text-gray-100 placeholder-gray-400"
              : "bg-white border-gray-300 text-gray-900 placeholder-gray-500"
          }`}
      ...
      {/* Email */}
      <div className="flex flex-col">
        <label htmlFor="email" className="mb-2 font-medium text-sm sm:text-base">
          Email
        </label>
        <input
          type="email"
      ...
      <div className="flex flex-col">
        ...
        <textarea
          ...
          onChange={handleChange}
          placeholder="Your message..."
          className={`px-4 py-3 rounded-md border resize-none text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 transition ${
            darkMode
              ? "bg-gray-800 border-gray-600 text-gray-100 placeholder-gray-400"
              : "bg-white border-gray-300 text-gray-900 placeholder-gray-500"
          }`}
      ...
      <button
        ...
        className={`py-3 rounded-md font-semibold text-white text-sm sm:text-base transition duration-300
        ${
          isSubmitting
            ? "bg-gray-500 cursor-not-allowed"
            : darkMode
